...
vlog -work work PLL24X2_tb.v

REM run the simulation
vsim -c -t ps +transport_int_delays -voptargs="+acc" -L secureip -L simprims_ver -sdfmax PLL24X2_tb\dut=..\..\implement\results\routed.sdf +no_notifier work.PLL24X2_tb work.glbl
