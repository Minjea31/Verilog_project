...
xst -ifn xst.scr
move PLL24X2_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\PLL24X2_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc PLL24X2_exdes.ucf PLL24X2_exdes

echo 'Running map'
map -timing -pr b PLL24X2_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm PLL24X2_exdes -w routed.ncd routed.v
cd ..
